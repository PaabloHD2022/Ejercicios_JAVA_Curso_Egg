...
En este paquete estará la clase DAO se encarga de conectarse con la base de datos y de
...
//        productoServicio.listarProductosYPrecios();
        productoServicio.listarProductosPrecioEntre102Y202();
