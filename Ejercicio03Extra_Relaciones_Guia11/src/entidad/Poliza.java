...
public class Poliza {
    ...
    public Poliza(int numeroPoliza, LocalDate fechaInicio, LocalDate fechaFin, int cantidadCuotas, String formaPago, double montoTotalAsegurado, boolean incluyeGranizo, double montoMaximoGranizo, String tipoCobertura, Vehiculo vehiculo, Cliente cliente) {
